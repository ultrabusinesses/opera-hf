...
"Copyright &copy; 2011-YYYY The OperaCoin developers"));
    ...
    {
        AboutDialog->setWindowTitle(QApplication::translate("AboutDialog", "About OperaCoin", 0));
        label->setText(QApplication::translate("AboutDialog", "<b>OperaCoin</b> version", 0));
